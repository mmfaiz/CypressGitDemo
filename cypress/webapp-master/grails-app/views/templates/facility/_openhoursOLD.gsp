...
<label class="control-label"  style="font-size: 16px">
    <g:message code="facility.openhours.label" default="Öppettider" />
</label>
<div class="clearfix"></div>
<g:each in="${(1..7)}">
    <label class="control-label">
        <g:message code="time.weekDay.plural.${it}"/>
    </label>
    <div class="controls">
        <div class="facility select-availability disabled" day="${it}">
            <label class="checkbox right-margin10 pull-left">
                <g:checkBox class="openHoursControl" name="active_${it}" day="${it}" data-title="Kryssad betyder öppet" rel="tooltip"/>
            </label>
            ...
            <span class="timeLabel" day="${it}">00:00 - 23:00</span>

            <div class="timeFilter" day="${it}" style="display: block"></div>
        </div>
        <div class="clearfix"></div>
    </div>
</g:each>
