                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.remotePaidConfirmation.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.remotePaidConfirmation.text1"/>
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.remotePaidConfirmation.text2"/><br>
                                                <hr>
                                                <g:message code="default.facility.label" />: <strong>${order.facility.name}</strong><br>
                                                <g:message code="order.article.${order.article.name()}" />: <strong>${order.description}</strong><br>
                                                <g:message code="templates.emails.paymentMethod"/>: <strong><g:message code="payment.method.${payment.method}"/></strong><br>
                                                <g:message code="default.amount.label"/>: <strong><g:formatMoney value="${payment.amount}" facility="${order.facility}" /></strong><br>
                                                <hr>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
