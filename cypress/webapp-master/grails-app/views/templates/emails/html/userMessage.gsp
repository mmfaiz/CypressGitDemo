            ...
            <table width="100%" style="width: 100%;">
                <tr>
                    ...
                    <td style="display: block!important;max-width: 600px!important;margin: 0 auto!important;">
                        <table cellpadding="15" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td><img src="${resource(dir:'/images', file:'logo.png' )}" width="50%" alt="MATCHi"/></td>
                                <td align="right">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.userMessage.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <h3 style="font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;line-height: 1.1;margin:0 0 15px;color: #000;font-weight: 500;font-size: 27px;">
                                                    <g:message code="templates.emails.greeting"/> ${toUser.fullName()}
                                                </h3>
                                                <!-- /Welcome block -->

                                                <!-- Welcome ingress -->
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.userMessage.text1" args="[fromUser.fullName()]"/>
                                                    <g:message code="templates.emails.html.userMessage.inboxLink" args="[inboxLink]"/>
                                                </p>
                                                <!-- /Welcome ingress -->
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table cellpadding="10"  width="100%" bgcolor="#e4eed6" style="background-color: #e4eed6;width: 100%;">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <g:message code="templates.emails.html.userMessage.text2" args="[fromUser.fullName()]"/><br>
