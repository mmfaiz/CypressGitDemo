                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.customerUpdateRequest.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.customerUpdateRequest.text1" args="[customer.facility.name]"/>
                                                </p>
                                            <!-- /Welcome ingress -->
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width: 100%;" width="100%">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <g:message code="templates.emails.html.customerUpdateRequest.text2"/><br>
