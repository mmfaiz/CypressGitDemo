<%@ page import="com.matchi.enums.MembershipRequestSetting; com.matchi.activities.trainingplanner.CourseActivity" contentType="text/html;charset=UTF-8" %>
                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.customerSubmission.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.customerCourse.message1"/>
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.customerCourse.message3"
                                                           args="[activity.name, customer.fullName()]" encodeAs="HTML"/>
                                                <!-- /Message body -->

                                                <g:if test="${activity.instanceOf(CourseActivity) && activity.extendedEmailMessage}">
                                                    <!-- extra body -->
                                                    <div class="extended-message">
                                                        <g:toRichHTML text="${activity.extendedEmailMessage}" />
                                                    </div>
                                                    <!-- /extra body -->
                                                </g:if>
                                            </td>
