                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.confirmationMail.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.confirmationMail.text1"/>
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.confirmationMail.text2"/><br><br>
                                                <g:message code="templates.emails.html.confirmationMail.instructions"/><br>
                                                <a href="${confirmationLink}" target="_blank"><g:message code="templates.emails.html.confirmationMail.confirmEmail"/></a>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <tr>
