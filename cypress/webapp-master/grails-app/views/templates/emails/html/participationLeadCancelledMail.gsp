                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                <g:set var="participationName" value="${participation.customer?.user ? participation.customer?.user?.fullName() : participation.customer?.fullName()}"/>

                                                <!-- Welcome ingress -->
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.participationLeadCancelledMail.text" args="[participationName, participation.occasion.activity.name, participation.occasion.startTime.toString('HH:mm'), participation.occasion.date.toString()]"/>
                                                </p>
                                            <!-- /Welcome ingress -->
