                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.membershipPaymentFailed.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                            ...
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <g:if test="${lastTry}">
                                                    <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                        <g:message code="templates.emails.html.membershipPaymentFailed.message3"
                                                                args="[formatMoney(value: order.price, facility: membership.customer.facility), failedAttemptsThreshold]"/>
                                                    </p>
                                                </g:if>
                                                <g:else>
                                                    <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                        <g:message code="templates.emails.html.membershipPaymentFailed.message1"
                                                                args="[formatMoney(value: order.price, facility: membership.customer.facility), new Date()]" encodeAs="HTML"/>
                                                    </p>
                                                    <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                        <g:message code="templates.emails.html.membershipPaymentFailed.message2"
                                                                args="[failedAttemptsThreshold]"/>
                                                    </p>
                                                </g:else>
