                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.customerInvitationMail.text1" args="[customer.facility.name]"/>
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.customerInvitationMail.text2" args="[customer.facility.name]"/>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <tr>
