                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.activityQueue.text1"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.activityQueue.text2" args="[occasion.startTime.toString('HH:mm'), occasion.date.toString('d/M'), facility.name, facilityLink]"/>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table width="100%" cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width: 100%;">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <em><g:message code="templates.emails.html.activityQueue.text3"/></em>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- /Callout Panel -->
