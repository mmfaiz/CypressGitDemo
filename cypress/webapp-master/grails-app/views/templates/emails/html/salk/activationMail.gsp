                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.activationMail.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <h3 style="font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;line-height: 1.1;margin:0 0 15px;color: #000;font-weight: 500;font-size: 27px;">
                                                    <g:message code="templates.emails.greeting"/> ${user.fullName()}
                                                </h3>
                                                <!-- /Welcome block -->

                                                <!-- Welcome ingress -->
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.salk.activationMail.text1"/>
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.salk.activationMail.text2"/><br><br>
                                                <g:message code="templates.emails.html.activationMail.instructions"/><br>
                                                <a href="${activationLink}" target="_blank"><g:message code="templates.emails.html.activationMail.activateAccount"/></a>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <g:if test="${showTerms}">
                                            <tr>
                                                <td>
                                                    ...
                                                    <table cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width: 100%;" width="100%">
                                                        <tr>
                                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                                <g:message code="templates.emails.html.activationMail.agreement" args="[userAgreement]"/>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- /Callout Panel -->
