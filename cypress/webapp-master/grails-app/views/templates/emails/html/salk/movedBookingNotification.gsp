                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.salk.movedBookingNotification.text" args="[
                                                            fromSlot.court.name,
                                                ...
                                                <g:set var="accessCode" value="${com.matchi.FacilityAccessCode.validAccessCodeFor(toSlot)?.content}"/>
                                        ...
                                        <g:if test="${sendInvite}">
                                            <tr>
                                                <!-- Invite -->
                                                <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                    <g:if test="${customer?.isCompany()}">
                                                        <g:message code="templates.emails.invite.company" args="[customer?.fullName()]"/><br>
                                                    </g:if>
                                                    <g:else>
