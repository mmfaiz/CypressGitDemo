                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.customerInvitationMail.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <g:message code="templates.emails.html.salk.customerInvitationMail.text1"/>
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.salk.customerInvitationMail.text2"/><br><br>

                                                <g:message code="templates.emails.html.salk.customerInvitationMail.text3"/>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <table cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width: 100%;" width="100%">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <g:message code="templates.emails.html.customerInvitationMail.instructions"/><br>
