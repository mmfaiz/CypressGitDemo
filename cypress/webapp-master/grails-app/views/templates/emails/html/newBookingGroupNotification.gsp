                            ...
                            <tr>
                                <td>
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.newBookingGroupNotification.text1" args="[bookings[0].slot.court.facility.name]"/>
                                                </p>
                                            <!-- /Welcome ingress -->
                                        ...
                                        <g:if test="${bookings.any{ it.showRemotePaymentNotificationInEmail() }}">
                                            <tr>
                                                <td>
                                                    ...
                                                    <table width="100%" cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width:100%;">
                                                        <tr>
                                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                                <p><g:message code="templates.emails.link.to.your.pending.payment.group"/>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table width="100%" cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width: 100%;">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <em><g:message code="templates.emails.html.newBookingGroupNotification.text2" args="[cancelRule]"/></em>
                                                            ...
                                                            <g:if test="${bookings[0]?.slot?.court?.facility?.bookingNotificationNote}">
                                                                <br><br>
                                                                <strong><g:message code="templates.emails.messageFrom"/> ${bookings[0].slot.court.facility.name}:</strong><br>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <g:render template="/templates/emails/facilityContactInfo"
                                                        model="[facility: bookings[0].slot.court.facility]"/>
                                                <!-- /social & contact -->
                                            </td>
                                        </tr>
                                    </table>
