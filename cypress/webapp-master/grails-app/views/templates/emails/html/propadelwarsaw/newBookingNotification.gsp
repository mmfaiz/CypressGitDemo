<%@ page import="com.matchi.payment.PaymentMethod; com.matchi.messages.FacilityMessage" contentType="text/html;charset=UTF-8" %>
                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <g:message code="court.label"/>: <strong>${booking.slot.court.name}</strong>
                                                ...
                                                <g:render template="/templates/emails/html/receiptLink" model="[order: booking.order]" />
                                            <!-- /Message body -->
                                            </td>
                                        </tr>
