                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.couponPurchaseReceipt.title.confirmation"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <h3 style="font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;line-height: 1.1;margin:0 0 15px;color: #000;font-weight: 500;font-size: 27px;">
                                                    <g:message code="templates.emails.greeting"/> ${customerCoupon.customer?.user ? customerCoupon.customer?.user?.fullName() : customerCoupon.customer?.fullName()}
                                                </h3>
                                                <!-- /Welcome block -->

                                                <!-- Welcome ingress -->
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.couponPurchaseReceipt.text1" args="[customerCoupon.coupon.name, customerCoupon.coupon.facility.name]"/>
                                                </p>
                                                <!-- /Welcome ingress -->
                                                ...
                                                <g:render template="/templates/emails/html/receiptLink" model="[order: order]" /><br>

                                                <g:message code="templates.emails.html.couponPurchaseReceipt.text2" args="[link]"/>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table width="100%" cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width:100%;">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <em><g:message code="templates.emails.html.couponPurchaseReceipt.text3" args="[purchaseAgreementLink]"/></em>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- /Callout Panel -->
                                        ...
                                        <g:if test="${sendInvite}">
                                            <tr>
                                                <!-- Invite -->
                                                <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                    <g:if test="${customerCoupon?.customer?.isCompany()}">
                                                        <g:message code="templates.emails.invite.company" args="[customerCoupon?.customer?.fullName()]"/><br>
                                                    </g:if>
                                                    <g:else>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <g:render template="/templates/emails/facilityContactInfo"
                                                        model="[facility: customerCoupon.coupon.facility]"/>
                                                <!-- /social & contact -->
                                            </td>
                                        </tr>
                                    </table>
