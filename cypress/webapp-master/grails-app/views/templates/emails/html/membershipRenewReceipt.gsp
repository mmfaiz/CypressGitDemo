                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.membershipRenewReceipt.message1"
                                                            args="[formatMoney(value: membership.order.price, facility: membership.customer.facility), membership.customer.facility.name, membership.startDate.toDate(), membership.endDate.toDate()]" encodeAs="HTML"/>
                                                </p>
                                                <!-- /Welcome ingress -->
                                                ...
                                                <g:if test="${order}">
                                                    ...
                                                    <strong><g:paymentShortSummary order="${order}" completedPaymentsOnly="true"/></strong>
                                                    <hr>
                                                </g:if>
