                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="notifications.automaticParticipationCancelledMail.subject"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.automaticParticipationLeadCancelledMail.text" args="[activityOccasion.activity.name, activityOccasion.startTime.toString('HH:mm'), activityOccasion.date.toString()]"/>
                                                </p>
                                            <!-- /Welcome ingress -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <g:render template="/templates/emails/facilityContactInfo"
                                                          model="[facility: activityOccasion.activity.facility]"/>
                                                <!-- /social & contact -->
                                            </td>
                                        </tr>
                                    </table>
