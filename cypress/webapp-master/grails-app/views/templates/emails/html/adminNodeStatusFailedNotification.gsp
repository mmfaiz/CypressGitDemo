                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.adminNodeStatusFailedNotification.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <h3 style="font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;line-height: 1.1;margin:0 0 15px;color: #000;font-weight: 500;font-size: 27px;">
                                                    <g:message code="templates.emails.html.adminNodeStatusFailedNotification.text1"/>
                                                </h3>
                                                <!-- /Welcome block -->

                                                <!-- Message body -->
                                                <p><g:message code="templates.emails.html.adminNodeStatusFailedNotification.text2" args="[facility.name]"/>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <tr>
