                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.membershipPaymentFailedAdmin.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.membershipPaymentFailedAdmin.message1" encodeAs="HTML"/>
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.membershipPaymentFailedAdmin.message2" encodeAs="HTML"/>
                                                </p>

                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.membershipPaymentFailedAdmin.customerName" encodeAs="HTML"/>:
                                                    <ul>
                                                        <g:each in="${customersData}" var="data">
                                                            <li><g:link controller="facilityCustomer" action="show" id="${data.id}" absolute="true" target="_blank">${data.name}</g:link></li>
                                                        </g:each>
                                                    </ul>
                                                </p>
                                                <!-- /Message body -->
