<%@ page import="com.matchi.enums.MembershipRequestSetting" contentType="text/html;charset=UTF-8" %>
                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.membershipRequestNotification.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                ...
                                <td>
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.membershipRequestNotification.text1" args="[customer.fullName()]"/>
                                                </p>
                                            <!-- /Welcome ingress -->

                                            <!-- Message body -->
                                                <g:if test="${facility.membershipRequestSetting.equals(MembershipRequestSetting.DIRECT)}">
                                                    <g:message code="templates.emails.html.membershipRequestNotification.text2" args="[requestSettings]"/>
                                                </g:if>
                                                <g:elseif test="${facility.membershipRequestSetting.equals(MembershipRequestSetting.MANUAL)}">
                                                    <g:message code="templates.emails.html.membershipRequestNotification.text3"/>
                                                </g:elseif>
                                            <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <!-- Callout Panel -->
                                                <table cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width: 100%;" width="100%">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <g:message code="templates.emails.linkToCustomer"/>:<br>
                                                    ...
                                                    <g:if test="${message}">
                                                        <tr>
                                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                                <g:message code="templates.emails.messageFromCustomer"/><br>
                                                                <g:toHTML text="${message}"/>
                                                            </td>
                                                        </tr>
                                                    </g:if>
                                                </table>
