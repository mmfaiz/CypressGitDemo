                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.newBookingNotification.title.confirmation"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.participationNewAdminMail.text1" args="[participation.occasion.activity.name, participation.occasion.startTime.toString('HH:mm'), participation.occasion.date.toString()]"/>
                                                </p>
                                            <!-- /Message body -->
                                                <hr>
                                                <g:message code="templates.emails.html.participationNewAdminMail.text2"/><br>
                                                <g:message code="default.name.label"/>: <strong>${participation.customer?.user ? participation.customer?.user?.fullName() : participation.customer?.fullName()}</strong><br>
                                                <g:message code="default.email.label"/>: <strong>${participation.customer?.email}</strong><br>
                                                <g:message code="templates.emails.html.participationNewAdminMail.text3"/>
                                                <hr>
                                            </td>
                                        </tr>
                                    </table>
