                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.subscriptionInformationMessage.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <!-- Message body -->
                                                <g:message code="templates.emails.html.subscriptionInformationMessage.text"/>
                                                <hr>
                                                <table width="100%">
                                                    <thead>
                                                    <tr>
                                                    ...
                                                    <g:each in="${subscriptions}" var="subscription">
                                                        <tr>
                                                            ...
                                                            <td><g:formatDate date="${subscription.slots.first().startTime}" format="${DateUtil.DEFAULT_DATE_FORMAT}"/></td>
