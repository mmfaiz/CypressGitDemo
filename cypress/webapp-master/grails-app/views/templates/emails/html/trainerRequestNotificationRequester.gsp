                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.trainerRequestNotificationRequester.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <h3 style="font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif;line-height: 1.1;margin:0 0 15px;color: #000;font-weight: 500;font-size: 27px;">
                                                    ...
                                                    ${trainerRequest.requester.fullName()}
                                                </h3>
                                                <!-- /Welcome block -->

                                                <!-- Welcome ingress -->
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.trainerRequestNotificationRequester.ingress" />
                                                </p>
                                                <!-- /Welcome ingress -->

                                                <!-- Message body -->
                                                <g:message code="default.facility.label"/>: <strong>${trainerRequest.trainer.facility}</strong><br/>
                                                <g:message code="default.date.label"/>: <strong><g:formatDate date="${trainerRequest.start}" format="yyyy-MM-dd"/></strong><br/>
                                                <g:message code="default.date.time"/>:  <strong><g:formatDate date="${trainerRequest.start}" format="HH:mm"/>-<g:formatDate date="${trainerRequest.end}" format="HH:mm"/></strong><br/>

                                                <p>
                                                    <g:message code="templates.emails.html.trainerRequestNotificationRequester.status.${trainerRequest.status}"/>
                                                </p>
                                            <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <table width="100%" cellpadding="10" bgcolor="#e4eed6" style="background-color: #e4eed6;width:100%;">
                                                    <tr>
                                                        <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                            <g:message code="templates.emails.html.trainerRequestNotificationRequester.text" args="[link]"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- /Callout Panel -->
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <g:render template="/templates/emails/facilityContactInfo"
                                                          model="[facility: trainerRequest.trainer.facility]"/>
                                                <!-- /social & contact -->
                                            </td>
                                        </tr>
                                    </table>
