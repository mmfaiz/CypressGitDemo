                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.bookingCanceledNotification.text1" args="[booking.slot.court.facility.name]"/>
                                                </p>
                                                <!-- /Welcome ingress -->
                                                ...
                                                <g:if test="${!hidePayment && payment && ![PaymentMethod.COUPON, PaymentMethod.GIFT_CARD].contains(payment.method)}">
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                    <g:if test="${booking?.customer?.isCompany()}">
                                                        <g:message code="templates.emails.html.bookingCanceledNotification.text2" args="[booking?.customer?.fullName()]"/>:<br>
                                                    </g:if>
                                                    <g:else>
                                                        <g:message code="templates.emails.html.bookingCanceledNotification.text3"/>:<br>
                                                    </g:else>
