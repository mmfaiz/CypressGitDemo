                        ...
                        <table cellpadding="5" bgcolor="#efefef" width="100%" style="width: 100%;">
                            <tr>
                                <td align="left">
                                    ...
                                    line-height: 1.1;
                                    margin: 15px 10px;"><g:message code="templates.emails.html.unverifiedCodeRequest.title"/></h6>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellspacing="10" width="100%" style="width: 100%;">
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <!-- Message body -->
                                                <p><g:message code="templates.emails.html.unverifiedCodeRequest.text1"
                                                              args="[new org.joda.time.DateTime(booking?.slot?.startTime).toString('HH:mm'),booking?.slot?.court?.name]"/></p>
                                                <!-- /Message body -->
                                            </td>
                                        </tr>
                                        <tr>
