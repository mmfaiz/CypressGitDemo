                                        ...
                                        <tr>
                                            <td style="font-weight: normal;font-size: 14px;line-height: 1.6;">
                                                ...
                                                <p class="lead" style="font-weight: normal;font-size: 17px;line-height: 1.6;">
                                                    <g:message code="templates.emails.html.automaticParticipationCancelledMail.text" args="[participation.occasion.activity.name, participation.occasion.startTime.toString('HH:mm'), participation.occasion.date.toString()]"/>
                                                </p>
                                            <!-- /Welcome ingress -->
                                            </td>
                                        </tr>
