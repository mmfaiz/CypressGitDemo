...
<ul class="breadcrumb">
    ...
    <li><g:message code="court.archived.label"/> (${courts?.size()})</li>
</ul>

<g:if test="${!facility?.isMasterFacility()}">
    <ul class="nav nav-tabs">
        <li class="${actionName == 'index' ? 'active' : ''}"><g:link action="index"><g:message code="court.label.plural"/></g:link></li>
        <li class="${actionName == 'archive' ? 'active' : ''}"><g:link action="archive"><g:message code="court.archive.label"/></g:link></li>
    </ul>
...
<r:script>
    $(document).ready(function() {
        $("table").find("a").has("i.icon-arrow-up").click(function() {
            ...
            console.log("id1: " + currentRow.attr("data-id"))
            console.log("id2: " + prevRow.attr("data-id"))
        });
