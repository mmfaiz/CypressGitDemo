...
<head>
    ...
    <title><g:message code="adminRegion.createMunicipality.title"/></title>
    ...
    <r:script>
        ...
        $(document).ready(function() {
            var mapOptions = {
                ...
                zoom: ${g.forJavaScript(data: cmd?.zoomlv ?: 10)},
...
<ul class="breadcrumb">
    ...
    <li><g:link action="edit" id="${cmd?.regionId ?: region.id}"><g:message code="adminRegion.edit.editRegion"/></g:link><span class="divider">/</span></li>
    <li class="active"><g:message code="adminRegion.createMunicipality.createMunicipality"/></li>
</ul>

<g:form name="municipalityForm" action="saveMunicipality" method="post" class="form-horizontal form-well">
    <g:hiddenField name="id" value="${cmd?.id}"/>
    <g:hiddenField name="regionId" value="${cmd?.regionId ?: region.id}"/>
    <g:hiddenField name="zoomlv" value="${cmd?.zoomlv ?: 10}"/>

    <div class="form-header">
        <g:message code="adminRegion.createMunicipality.createMunicipality"/><span class="ingress"><g:message code="default.form.create.instructions"/></span>
    </div>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            <g:link action="edit" id="${cmd?.regionId ?: region.id}" class="btn btn-danger" tabindex="5"><g:message code="button.cancel.label"/></g:link>
        </div>
    </fieldset>
</g:form>
