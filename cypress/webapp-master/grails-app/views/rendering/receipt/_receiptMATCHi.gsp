...
<div class="footer" style="margin-top: -20pt;height:80mm">
    <table width="100%">
        <tr>
            <td width="40%"><g:message code="default.phone.label"/>: <g:message code="rendering.invoice.matchi.text.phoneNr"/></td>
            <td width="40%" align="right"><g:message code="rendering.invoice.invoice.message1"/></td>
        </tr>
        <tr>
            <td width="40%"><g:message code="default.email.label"/>: <g:message code="rendering.invoice.matchi.text.email" /></td>
            <td width="40%" align="right"><g:message code="rendering.invoice.invoice.message20"/>: <g:message code="rendering.invoice.matchi.text.orgNr"/></td>
        </tr>
    </table>
</div>
...
<table width="200mm" cellpadding="0" border="0">
    <tr>
        <td valign="top" width="50%">
            ...
            <br/><br/>
            <strong><g:message code="rendering.invoice.matchi.title"/></strong><br/>
            <g:message code="rendering.invoice.matchi.text.address"/><br/>
            <g:message code="rendering.invoice.matchi.text.city"/><br/>
            <g:message code="rendering.invoice.matchi.text.country"/><br/>
            ...
            <table border="0">
                <tr>
                    <td valign="top" align="center">
                        <img style="height: 100px; max-width: 50%;" src="data:image/png;base64,${matchiLogoString}" alt="${facility.name.encodeAsHTML()}" class="img-responsive"/>
                    </td>
                </tr>
            </table>
        </td>
