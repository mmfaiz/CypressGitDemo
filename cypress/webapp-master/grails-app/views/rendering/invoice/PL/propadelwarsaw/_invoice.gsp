    ...
    <div class="footer" style="margin-top: -10pt;height:80mm">
        <table width="100%">
            <tr>
                ...
                <td width="40%">
                    <span>VAT/NIP: PL9512428088</span>
                </td>

                <td width="30%"><g:message code="rendering.invoice.invoice.message15"/>: ${facility.getFacilityPropertyValue(FacilityProperty.FacilityPropertyKey.INVOICE_COMPANY_HOME.toString())}</td>
            </tr>
            <tr>
                ...
                <td width="40%">
                    <span><g:message code="rendering.invoice.invoice.message20"/>: ${facility.orgnr}</span>
                </td>
                <td width="30%"><g:message code="rendering.invoice.invoice.message1"/></td>
            </tr>
        </table>
    </div>
        ...
        <tr>
            <td valign="top" width="100mm">
                ...
                <p style="margin-top: 3mm">
                    ...
                    Organisation number: ${invoice.customer.orgNumber}<br/>
                    VAT/NIP: ${invoice.customer.vatNumber}
                </p>
