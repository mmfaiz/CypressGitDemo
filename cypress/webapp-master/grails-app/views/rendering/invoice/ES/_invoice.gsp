    ...
    <table width="200mm" cellpadding="0" border="0">
        <tr>
            <td valign="top" width="100mm">
                ...
                <h1>${facility.getFacilityPropertyValue(FacilityProperty.FacilityPropertyKey.INVOICE_FACILITY_NAME.toString()) ?: facility.name}</h1>
                <p>
                    ${facility.getFacilityPropertyValue(FacilityProperty.FacilityPropertyKey.INVOICE_COMPANY_HOME.toString())}<br/>
                    ${facility.address}<br/>
                        ...
                        <td>
                            ...
                            <table width="90mm" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><strong><g:message code="rendering.invoice.invoice.message4"/></strong><br/>${facility?.salesPerson}${invoice.getOCR()}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td height="29mm" valign="top">
                            <p style="margin-top: 3mm">
                                <g:set var="address" value="${invoice.customer.getInvoiceAddress(namePrefix)}"/>
                                <g:each in="${address.names}">
                                    <b>${it}</b><br/>
                                </g:each>
                                ${invoice.customer?.personalNumber ? invoice.customer.personalNumber : ""}<br/>
                                ${address.address1}<br/>
                ...
                <div class="main">
                    ...
                    <table border="0" width="100%">
                        ...
                        <g:if test="${invoice.getTotalVAT() > 0}">
                            <tr>
                                <th colspan="${colspanShort}" align="right"><g:message code="default.vat.label"/></th> ${facility?.vat}%
