<html>
    <head>
        ...
        <title><g:message code="facility.customer.addToGroup.title"/></title>
    </head>

    <body>
        <g:render template="add/breadcrumb" model="[wizardStep: 1]"/>

        <h3><g:message code="facility.customer.addToGroup.confirm.title"/></h3>
        <p class="lead">
            <g:message code="facility.customer.addToGroup.confirm.desc"
