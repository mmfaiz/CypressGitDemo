...
<head>
    ...
    <title><g:message code="button.archive.label"/></title>
</head>
<body>
<ul class="breadcrumb">
    ...
    <li><g:link controller="facilityCustomerArchive" action="index"><g:message code="facilityCustomerArchive.archive.confirm.message3"/></g:link> <span class="divider">/</span></li>
    <li class="active"><g:message code="facilityCustomerArchive.archive.confirm.message4"/></li>
</ul>

<h3><g:message code="facilityCustomerArchive.archive.confirm.message5"/></h3>
<g:if test="${!customers}">
    <p class="lead">
        <g:message code="facilityCustomerArchive.archive.confirm.message6"/></p>
...
<g:else>
    <p class="lead">
        <g:message code="facilityCustomerArchive.archive.confirm.message13"/></p>
