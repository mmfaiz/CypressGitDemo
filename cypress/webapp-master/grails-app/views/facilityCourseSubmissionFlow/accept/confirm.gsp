...
<g:form class="form-inline">
    <g:render template="/templates/wizard"
              model="[steps: [message(code: 'facilityCourseSubmission.acceptFlow.general.wizard.step1'), message(code: 'facilityCourseSubmission.acceptFlow.general.wizard.step2'), message(code: 'default.completed.message')], current: 1]"/>
    ...
    <p class="lead no-bottom-margin">
        ${message(code: "facilityCourseSubmission.accept.confirm.description")}
    </p>
