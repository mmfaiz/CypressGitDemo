...
<g:form class="form-inline">
    <g:render template="/templates/wizard"
              model="[steps: [message(code: 'facilityCourseSubmission.denyFlow.general.wizard.step1'), message(code: 'default.completed.message')], current: 0]"/>
    ...
    <p class="lead no-bottom-margin">
        ${message(code: "facilityCourseSubmission.deny.confirm.description")}
    </p>
