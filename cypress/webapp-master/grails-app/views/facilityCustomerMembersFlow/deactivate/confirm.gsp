...
<ul class="breadcrumb">
    ...
    <li class="active"><g:message code="facilityCustomerMembers.deactivate.confirm.message4"/></li>
</ul>

<h3><g:message code="facilityCustomerMembers.deactivate.confirm.message5"/></h3>
<g:if test="${!membersInfo}">
    <p class="lead">
        <g:message code="facilityCustomerMembers.deactivate.confirm.message6"/></p>
...
<g:else>
    ...
    <p class="lead">
        <g:message code="facilityCustomerMembers.deactivate.confirm.message12"/>
    </p>

    <div class="alert">
        <button type="button" class="close" data-dismiss="alert"><i class="fa fa-times-circle"></i></button>
        <g:message code="facilityCustomerMembers.deactivate.note"/>
    </div>
