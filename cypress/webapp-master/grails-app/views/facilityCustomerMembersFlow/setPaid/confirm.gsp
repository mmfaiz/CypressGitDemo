...
<body>
    <ul class="breadcrumb">
        ...
        <li class="active"><g:message code="facilityCustomerMembers.setPaid.title"/></li>
    </ul>

    <h3><g:message code="facilityCustomerMembers.setPaid.heading"/></h3>

    <p class="lead">
        <g:message code="facilityCustomerMembers.setPaid.description"/>
    </p>
    ...
    <g:if test="${pendingMemberships || freeMemberships || paidMemberships || invoicedMemberships}">
        <div class="alert">
            <button type="button" class="close" data-dismiss="alert"><i class="fa fa-times-circle"></i></button>
            ...
            <g:if test="${freeMemberships}">
                <div>
                    <g:message code="facilityCustomerMembers.setPaid.freeMemberships"
                            args="[freeMemberships]"/>
                </div>
            </g:if>
            <g:if test="${paidMemberships}">
                <div>
                    <g:message code="facilityCustomerMembers.setPaid.paidMemberships"
                            args="[paidMemberships]"/>
                </div>
            </g:if>
            <g:if test="${invoicedMemberships}">
                <div>
                    <g:message code="facilityCustomerMembers.setPaid.invoicedMemberships"
